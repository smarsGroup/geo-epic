...
def download_ssurgo_data(row):
    _, lon, lat, daymet_id = row.values()
    full_url = f"https://ssurgo.covercrop-data.org/?lat={lat}&lon={lon}&server=usda&categories=-legend,-textureclass,-parentmaterial,-restrictions"
