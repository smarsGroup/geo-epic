...
import shutil
import subprocess
from geo_epic.weather import DailyWeather
import numpy as np
import pandas as pd
from geo_epic.misc import ConfigParser
from geo_epic.misc.utils import *
...
parallel_executor(process_model, info_ls, max_workers = config["num_of_workers"], timeout = config["timeout"])
